...
* **Sistema de Logs:** Registre automàtic de tots els esdeveniments, alertes enviades i estat del bot (inici/aturada) al fitxer `sistem-monitor_YYYY-MM-DD.txt` per a una traçabilitat completa i depuració.
